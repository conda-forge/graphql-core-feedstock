...
Home: https://pypi.org/project/graphql-core
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/graphql-core-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/graphql-core-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add graphql-core
# for installing globally
pixi global install graphql-core
```
...
It is possible to list all of the versions of `graphql-core` available on your platform:
...
```
pixi search graphql-core --channel conda-forge
```
